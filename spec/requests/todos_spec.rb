...
RSpec.describe "/todos", type: :request do
  ...
  before(:each) do
    FactoryBot.create(:todo, text:"Todo test 1")
    FactoryBot.create(:todo, text:"Todo test 2")
  end

  describe "get all todos at /todos" do
  ...
  describe "get all todo at /todos/:id" do
    it "returns a todo based on the params" do
      get "/todos/3"
      expect(response).to have_http_status(:success)

      expect(response.body).to include("Todo test 1")
      # print JSON.parse(response.body)
      # expect(JSON.parse(response.body).size).to eq(2)
    end
